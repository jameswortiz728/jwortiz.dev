            ...
            <div id="projects" className="spacer">
                <div className="content-container">
                    <div className="section">
                        <div>
                            <h1 className="page-header__big">Projects</h1>
                            <p>Click or tap on each box to learn more about each project</p>
                            <div className="show-for-desktop"><button onClick={() => handleScrollTo('resume')} className="button">Next Section: Resume</button></div>
                        </div> 
                        <div >                
                            <ProjectList/>
                            <div className="show-for-mobile"><button onClick={() => handleScrollTo('resume')} className="button">Next Section: Resume</button></div>
                        </div>
                    </div>
                </div>
            </div>
